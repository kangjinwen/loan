...
public abstract class BranchingProcessHistoryRecorderService extends BusinessBaseService
		implements HistoryRecordableService, CompleteProcessService, StartProcessService {
...
//        dealWithGenericEndPoint(basicServiceDataBean);
	 ...
	 * @since 1.0.0
	 */
	protected void updateBranchingProcessResult(String processingOpinion, String branchingProcessInstanceId)
			throws ServiceException {
