 ...
 *
 */
public class CollateralRegistCompletionListener extends AbstractTaskCompletionListenerTemplate{
	...
	protected void doComplete(BasicServiceDataBean serviceDataBean,
		...
		try {
			...
			collateralRegistService.regist((CollateralRegistDataBean)serviceDataBean);
