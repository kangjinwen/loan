...
/**
 * User: mcwang DateTime:2016-08-08 04:18:34 details: 押品登记表,Action请求层
 */
@Controller
...
public class CollateralManageAction extends BaseAction {
	...
	public void saveOrUpdateCollateralRegist(HttpServletRequest request, HttpServletResponse response,
		...
		HousMortgageRegistration hmr = collateralManageService
				.getHousMortgageRegistrationByInstanceId(processInstanceId);
		if (hmr != null) {
			// 修改数据
