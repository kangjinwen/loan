...
public class CollateralTaskServiceImpl  implements CollateralTaskService{
	...
	private static final String RELIEVE_HOUSE_PROCESS= "relieveProcess";
...
//			}
	...
	@Override
	public PageInfo<Map<String, Object>> getCollateralRegistAssignTaskList(
	...
	@Override
	public PageInfo<Map<String, Object>> getCollateralRelieveAssignTaskList(
			Map<String, Object> map) throws Exception {
		// TODO Auto-generated method stub
		List<Map<String,Object>> returnMap = new ArrayList<Map<String,Object>>();
		try {
...
//	}
	...
	* @throws
	 */
	 public void startRelieveHouse(String processInstanceId,Long projectId,long userId
	            ) throws Exception {
