...
public class AdvanceCustomerServiceConfirmTaskCompletionListener extends AbstractTaskCompletionListenerTemplate{
	...
	protected void doComplete(BasicServiceDataBean serviceDataBean,
		...
		try  {
			...
			advanceConfirmService.advanceCustomerServiceConfirmTask((AdvanceConfirmTaskDataBean) serviceDataBean, delegateTask);
		} catch (Exception e) {
