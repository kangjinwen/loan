...
public class AdvanceConfirmTaskCompletionListener extends AbstractTaskCompletionListenerTemplate{
	...
	protected void doComplete(BasicServiceDataBean serviceDataBean,
		...
		try  {
			...
			advanceConfirmService.advanceConfirmTask((AdvanceConfirmTaskDataBean) serviceDataBean, delegateTask);
		} catch (Exception e) {
