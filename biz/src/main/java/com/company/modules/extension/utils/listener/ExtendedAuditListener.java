 ...
 *
 */
public class ExtendedAuditListener extends AbstractTaskCompletionListenerTemplate{
	...
	protected BasicServiceDataBean parseDataBean(DelegateTask delegateTask,
		...
		return classTypeParser.parse(serviceVariables, ExtendedAuditDataBean.class);
	}
	...
	protected void doComplete(BasicServiceDataBean dataBean,
		...
		// TODO Auto-generated method stub
		try {
			ExtendedAuditService extendedAuditService=(ExtendedAuditService) ApplicationContextHelperBean.getBean("extendedAuditServiceImpl");
			extendedAuditService.audit((ExtendedAuditDataBean)dataBean);
