 ...
 *
 */
public class ExtendedPreliminaryEvaluationTaskCompletionListener extends AbstractTaskCompletionListenerTemplate {
	...
	protected void doComplete(BasicServiceDataBean serviceDataBean, DelegateTask delegateTask) {
		try  {
			...
			extensionCustomerEvaluationService.evaluation((ExtensionPreliminaryEvaluationDataBean)serviceDataBean);
		} catch (Exception e) {
