 ...
 *
 */
public class PreliminaryEvaluationTaskCompletionListener extends AbstractTaskCompletionListenerTemplate {
	...
	protected void doComplete(BasicServiceDataBean serviceDataBean, DelegateTask delegateTask) {
		try  {
			CustomerEvaluationService customerEvaluationService = (CustomerEvaluationService) ApplicationContextHelperBean.getBean("preliminaryEvaluationServiceImpl");
