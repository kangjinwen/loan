 ...
 *
 */
public class CustomerConnectionTaskCompletionListener extends AbstractTaskCompletionListenerTemplate {
	...
	protected void doComplete(BasicServiceDataBean serviceDataBean, DelegateTask delegateTask) {
		try  {
			CustomerEvaluationService customerEvaluationService = (CustomerEvaluationService) ApplicationContextHelperBean.getBean("customerConnectionServiceImpl");
