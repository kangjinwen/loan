  ...
  render() {
    return (
      <div className="Mytabs">
        <Tabs activeKey={this.state.activeId} onChange={this.onChange} destroyInactiveTabPane animation={null} contentStyle={{ minHeight: document.body.clientHeight - 100, overflow: 'auto' }}>
          {
