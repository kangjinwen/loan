...
export default React.createClass({
  ...
  downLoadProject() {//项目
    ...
    var exportPoint = "usertask-face-review";
  ...
  fetch(params = {}) {
    ...
    Utils.ajaxData({
      url: '/modules/workflow/ProcessTaskController/queryAuditTasks.htm?isCompleted=true&&type=usertask-face-review',
      data: params,
      callback: (result) => {
  ...
  render() {
    ...
    return (
      <div className="block-panel">
        ...
        <AddlWin ref="AddlWin"  visible={state.visible}
          formData={state.formData}  id={state.id}
          title={state.title} hideModal={me.hideModal}
          record={state.selectedrecord} canEdit={state.canEdit}/>
      </div>
    );
  }
})
