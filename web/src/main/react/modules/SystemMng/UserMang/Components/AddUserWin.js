                    ...
                    <Row>
                        <Col span="12">
                            <FormItem  {...formItemLayout} label="工号：">
                                <Input disabled={!props.canEdit}  {...getFieldProps('number', {
                                    rules: [{
                                        required: true,
                                        message: '必填'
                                    }]
                        ...
                        <Col span="12">
                            <FormItem  {...formItemLayout} label="真实姓名：">
                                <Input disabled={!props.canEdit}  {...getFieldProps('name', {
                                    rules: [{
                                        required: true,
                                        message: '必填'
                                    }]
                    ...
                    <Row>
                        <Col span="12">
                            <FormItem  {...formItemLayout} label="用户名称：">
                                <Input disabled={!props.canEdit}  {...getFieldProps('userName', {
                                    rules: [{
                                        required: true,
                                        message: '必填'
                                    }]
                        ...
                        <Col span="12">
                            <FormItem  {...formItemLayout} label="所属部门：">
                                <TreeSelect disabled={!props.canEdit} dropdownStyle={{maxHeight: 400, overflow: 'auto'}}
                                            treeData={treeData}
                    ...
                    <Row>
                        <Col span="12">
                            <FormItem  {...formItemLayout} label="用户角色：">
                                <Select disabled={!props.canEdit} multiple  {...getFieldProps('roleId', {
                                    rules: [{
                                        required: true,
                                        message: '必填',
                                        type: 'array'
                        ...
                        <Col span="12">
                            <FormItem  {...formItemLayout} label="职位">
                                <Select id="select" size="large"
                                        disabled={!props.canEdit} {...getFieldProps('position', {
                                    rules: [{
                                        required: true,
                                        message: '必填',
                                        type: 'number'
                    ...
                    <Row>
                        ...
                        <Col span="12">
                            <FormItem  {...formItemLayout} label="管辖机构">
                                <TreeSelect disabled={!props.canEdit} dropdownStyle={{maxHeight: 400, overflow: 'auto'}}
                                            treeData={treeData} placeholder="请选择"
                                            treeDefaultExpandAll {...getFieldProps('officeOver')} multiple={true}
                                            treeCheckable={true}/>
                            </FormItem>
                        </Col>
                    </Row>
