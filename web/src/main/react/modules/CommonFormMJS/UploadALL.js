      ...
      <div style={{ position: "relative" }}>
        <div className="navLine-wrap" onScroll={NavLineUtils._handleSpy.bind(this, this.navLineData) }>
          <div className="col-20 navLine-wrap-left" >
            ...
            <div id="u1" >
              <h2>身份证</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"IDCARD"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <div id="u3" >
              <h2>户口本</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"HOUSEHOLD"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <div id="u4" >
              <h2>婚姻证明</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"MARRIAGE"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <div id="u5" >
              <h2>征信资料</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"CREDIT"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            {/*<h1 id="H2">筛查信息</h1>
              <div id="u6" >
                <h2>建委</h2>
            ...
            <div id="u14" >
              <h2>房产资料</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} otherType={otherType} idData={idData} btype ={"HOUSE"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            {/*<div id="u15" >
                <h2>世联</h2>
            ...
            <div id="u25" >
              <h2>风控单</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} otherType={otherType} idData={idData} btype ={"RISK"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <h1 id="H7">合同信息</h1>
            <div id="u27" >
              <h2>合同与签合同照片</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"Contract_Pic"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <h1 id="H8">公证登记</h1>
            <div id="u28" >
              <h2>公证回执单</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"HUIZHIDAN"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <div id="u29" >
              <h2>公证材料</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"JUSTICE"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <h1 id="H9">抵押登记</h1>
            <div id="u30" >
              <h2>抵押回执单</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"MortgageReceipt"} canEdit={canEdit}canUpload={canUpload}/>
            </div>
            <div id="u31" >
              <h2>放款卡</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"CardNumber"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <div id="u32" >
              <h2>三方卡</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"ThirdCardNumber"} canEdit={canEdit} canUpload={canUpload}/>
            </div>
            <div id="u33" >
              <h2>他项权利证材料</h2>
              <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"MATERIAL"} canEdit={canEdit} canUpload={canUpload}/>
          </div>
          <h1 id="H11">其他</h1>
              <div id="u36" >
                  <h2>流水</h2>
                  <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"Water"} canEdit={canEdit} canUpload={canUpload}/>
              </div>
              <div id="u37" >
                  <h2>产调</h2>
                  <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"Production"} canEdit={canEdit} canUpload={canUpload}/>
              </div>
              <div id="u38" >
                  <h2>备用房产证</h2>
                  <UploadItem selectRecord={selectRecord} otherType={otherType} idData={idData} btype ={"HouseBak"} canEdit={canEdit} canUpload={canUpload}/>
              </div>
            {/*<h1 id="H10">展期信息</h1>
            <div id="u34" >
              <h2>展期协议</h2>
