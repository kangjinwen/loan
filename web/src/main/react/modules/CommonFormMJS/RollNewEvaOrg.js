...
var RollNewEvaOrg = React.createClass({
    getInitialState() {
        return {
            orgData: [],
            keys: [],
        ...
        const formItems = getFieldValue('keys').map((k) => {
            ...
            return (<tr key={k}>
                ...
                <td key={`k3`}>
                    ...
                    {canUpload ? <RollUploadPhoto   btype={`evaOrg${k}`} canEdit={this.props.canEdit} selectRecord={this.props.record}/> : null}
                </td>
...
RollNewEvaOrg = createForm()(RollNewEvaOrg);
export default RollNewEvaOrg;