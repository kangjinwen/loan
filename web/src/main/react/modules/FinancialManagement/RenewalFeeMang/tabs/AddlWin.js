            ...
            if (!!errors) {
                ...
                validation3((errors, values) => {
                    if (!!errors) {
                        ...
                        pubProcessBranching.collectionForm = Charge.collectionForm;//收取形式
                        pubProcessBranching.actualExtensionFee = Charge.actualExtensionFee;//实收展期费
                        pubProcessBranching.financeSpecialist = Charge.financeSpecialist;//财务专员
